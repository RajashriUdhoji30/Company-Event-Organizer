...
var Control = function (_Component) {
  ...
  _createClass(Control, [{
    ...
    value: function componentWillMount() {
      ...
      if (parser) {
        ...
        if (parsedValue !== modelValue) {
          dispatch(_actions2.default.change(model, parsedValue));
        }
      }
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var validateOn = _props2.validateOn;
    ...
    value: function validate() {
      ...
      var modelValue = _props4.modelValue;
      var fieldValue = _props4.fieldValue;
      var validators = _props4.validators;
      var errorValidators = _props4.errors;
    ...
    value: function render() {
      ...
      var _props5$controlProps = _props5.controlProps;
      var controlProps = _props5$controlProps === undefined ? {} : _props5$controlProps;
      var component = _props5.component;
      var control = _props5.control;
...
Control.propTypes = {
  ...
  componentMap: _react.PropTypes.object, // will be deprecated
